...
class Command {
    ...
    private:
        ...
        const std::string ACT_LIST[12]={"[iIaA]", "([1-9][0-9]*)?[hjkl]", "([1-9][0-9]*)?[oO]", "[_$0]", "(gg|G|[1-9][0-9]*G)", "[1-9][0-9]*gt", "([1-9][0-9]*)?[wb]", "[fFtT].", "v", "V", "[pP]", "x"};
		const std::string VIS_LIST[7]={"([1-9][0-9]*)?[hjkl]", "[xd]", "[uU]", "(gg|G|[1-9][0-9]*G)", "y", "([1-9][0-9]*)?[wb]", "[_$0]"};
