...
StatusBar::StatusBar(wxWindow *parent) : wxWindow(parent, wxID_ANY, wxDefaultPosition, wxSize(wxGetDisplaySize().GetWidth()/2, 30)) {
	...
	modeDisplay = new StatusSection(this, wxSize(90, 30), wxSize(90, 30), wxColour(219, 131, 0), wxColour(255, 255, 255));
	modeDisplay->setText("~ NORMAL ~");

	pathDisplay = new StatusSection(this, wxSize(90, 30), parent->GetMaxClientSize(), wxColour(214, 141, 141), wxColour(194, 81, 81));
	pathDisplay->setText("[NO FILE]");

	positionDisplay = new StatusSection(this, wxSize(90, 30), wxSize(150, 30), wxColour(171, 141, 214), wxColour(0, 0, 0));
	positionDisplay->setText("1,1 | 100%");

	sizeDisplay = new StatusSection(this, wxSize(150, 30), wxSize(210, 30), wxColour(136, 178, 194), wxColour(0, 0, 0));
